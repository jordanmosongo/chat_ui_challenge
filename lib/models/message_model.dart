...
List<Message> chats = [
  Message(
      currentUser,
      '4h30',
      'Hi! my name\'s Jordan and I am the one who will change this country. Changing the social life of congolese people is not some thing easy but it is not also touch. Just think and put in practice',
      false,
      true),
  Message(glody, '4h30', 'Hi! my name\'s Diglo', false, true),
  Message(gloire, '4h30', 'Hi! my name\'s Diglo', false, false),
  Message(john, '4h30', 'Hi! my name\'s Diglo', true, true),
  Message(emminence, '4h30', 'Hi! my name\'s Diglo', false, false),
  Message(glody, '4h30', 'Hi! my name\'s Diglo', true, false),
  Message(gloire, '4h30', 'Hi! my name\'s Diglo', false, true),
  Message(john, '4h30', 'Hi! my name\'s Diglo', false, true),
  Message(emminence, '4h30', 'Hi! my name\'s Diglo', true, false),
];
